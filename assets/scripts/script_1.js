...
function donutChart() {
    var width,
        ...
        //colour = d3.scaleOrdinal().range(["#0FA3B1", "#73c3bf", "#a1d8c8", "#cbe0a7", "#f2db84", "#f7af72", "#FF9B42"]), // old colour scheme
        colour = d3.scaleOrdinal().range(["#ff42cf", "#fc85de", "#ffec23", "#ffb223", "#fc4535", "#77b9ff", "#1183fc"]), // new color scheme
